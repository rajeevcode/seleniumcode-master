...
public class GenericMethodsOld {
  ...
  public GenericMethodsOld(WebDriver driver) {
    ...
    /* driver.findElement returns NoElementException when element is not found but driver.findElements
will not return exception as it will return list of elements.
 */
