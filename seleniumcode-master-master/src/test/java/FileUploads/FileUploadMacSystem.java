...
public class FileUploadMacSystem {
  ...
  public void fileUpload() throws AWTException, InterruptedException {
    driver.findElement( By.xpath (  "//input[@id='identifierId']" )).sendKeys ("xyz");
    ...
    Thread.sleep ( 2000 );
    driver.findElement(By.xpath("//div[@class='wO nr l1']//textarea")).sendKeys("rajeevlazada@gmail.com");
